    ...
    describe('lib', function () {
        describe('time', function () {
            ...
            it('should get correct decimal seconds', function () {
                ...
                date = new Date(2014, 4, 10, 0, 0, 10, 0);
            ...
            it('should get correct decimal minutes', function () {
                ...
                date = new Date(2014, 4, 10, 0, 10, 0, 0);
